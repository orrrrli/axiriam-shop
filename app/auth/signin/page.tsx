    ...
    try {
      if (DEMO_MODE) {
        ...
        if (res.ok) {
          ...
          setAuthStatus({ type: 'error', message: data.error || 'Invalid credentials' });
      ...
      <div className="w-[80rem] max-md:w-full max-md:px-[1.6rem]">
        <div className="flex border border-border max-md:flex-col animate-slide-up">
          ...
          <div className="flex-1 p-[3rem]">
            ...
            <h3 className="text-heading text-[2rem] mb-[0.5rem]">Sign In</h3>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-[2rem]">
                <div className="flex items-center justify-between mb-[0.5rem]">
                  <label className="block text-[1.2rem] text-paragraph">
                    * Password
                  </label>
                </div>
                <input
          ...
          {/* Right side — Social + Sign Up redirect */}
          <div className="flex-1 p-[3rem] flex flex-col justify-center">
            <div className="mb-[3rem]">
              <h5 className="text-heading text-[1.4rem] mb-[1.5rem]">Sign in with</h5>
            ...
            <div className="border-t border-border pt-[2rem] flex items-center justify-between max-md:flex-col max-md:text-center max-md:gap-[1rem]">
              ...
              <Link href="/auth/signup" className="button button-muted">
                Sign Up
              </Link>
            </div>
          </div>
